...
export default function LoginPage(){
    return(
        ...
        <Image
              src="/persona.png" width={400} height={190} className="w-86 h-86"/>
              </div>
              </div>
              </section>
        </div>
        ...
        <h2 class="text-6xl font-mono flex justify-center text-blue-800 mt-20 mb-10">WELCOME BACK</h2>
        <div class="fjustify-items-center ">
