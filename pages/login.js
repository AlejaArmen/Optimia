...
export default function LoginPage(){
    return(
        ...
        <div className="absolute top-1/4 left-1/4 w-1/4 h-1/2"> 
        <div className="mx-auto flex justify-center mt-0">
            <Image
              src="/logo.png" width={150} height={190} className="rounded-10"/>
          </div>
          <div class="text-center">
        <h2 class="text-6xl font-mono flex justify-center text-blue-700 mt-10">WELCOME BACK</h2>
        </div>
